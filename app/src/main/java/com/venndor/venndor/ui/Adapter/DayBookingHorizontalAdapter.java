...
public class DayBookingHorizontalAdapter extends RecyclerView.Adapter<DayBookingHorizontalAdapter.myViewHolder> {

    ArrayList<String> modelArrayList;
    Context context;

    private AddPackageCategoriesSubListener itemClickListenerr;
    String selectedId = "Active Booking";


    public DayBookingHorizontalAdapter(ArrayList<String> modelArrayList, Context context, AddPackageCategoriesSubListener itemClickListenerr) {
