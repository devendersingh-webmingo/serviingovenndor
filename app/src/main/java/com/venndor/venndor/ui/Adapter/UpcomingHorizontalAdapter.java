...
public class UpcomingHorizontalAdapter extends RecyclerView.Adapter<UpcomingHorizontalAdapter.myViewHolder> {

    ArrayList<String> modelArrayList;
    Context context;

    private AddPackageCategoriesSubListener itemClickListenerr;
    String selectedId = "Pending Approvals";


    public UpcomingHorizontalAdapter(ArrayList<String> modelArrayList, Context context, AddPackageCategoriesSubListener itemClickListenerr) {
