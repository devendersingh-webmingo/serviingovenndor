...
public class Preferences {
    ...
    private String prefName	=	"freetads";
    //=====
    ...
    //=====
    public int getInt(String key, int position){
    ...
    public void clear() {
        SharedPreferences sharedPreferences = _context.getSharedPreferences(prefName, Context.MODE_PRIVATE);
